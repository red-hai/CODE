...
typedef enum
{
  CHASSIS_ZERO_FORCE,                  //底盘无力  0
  CHASSIS_NO_MOVE,                     //底盘保持不动  1
  CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW,  //正常步兵底盘跟随云台  2
  CHASSIS_ENGINEER_FOLLOW_CHASSIS_YAW, //  3  工程底盘角度控制底盘，由于底盘未有陀螺仪，故而角度是减去云台角度而得到，如果有底盘陀螺仪请更新底盘的yaw，pitch，roll角度
  CHASSIS_NO_FOLLOW_YAW,               //  4  底盘不跟随角度，角度是开环的，但前后左右是有速度环
  CHASSIS_OPEN                         //  5 遥控器的值乘以比例直接发送到can总线上
} chassis_behaviour_e;
