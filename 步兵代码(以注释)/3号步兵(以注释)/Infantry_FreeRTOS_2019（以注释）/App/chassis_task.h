...
#define M3505_MOTOR_SPEED_PID_KI 3.0f
...
typedef struct
{
  const RC_ctrl_t *chassis_RC;               //底盘使用的遥控器指针
	...
	//chassis_yaw_motor和chassis_pitch_motor的类型都是云台数据的的结构体Gimbal_Motor_t
  ...
  fp32 vy_min_speed;  //左右方向最小速度 单位m/s
	...
	//底盘参考系
	//这三个就是底盘的姿态角（通过云台陀螺仪和云台和底盘之间的相对的编码器角度来得到）
  fp32 chassis_yaw;   //陀螺仪和云台电机叠加的yaw角度，底盘Y轴方向陀螺仪的姿态角
  fp32 chassis_pitch; //陀螺仪和云台电机叠加的pitch角度，底盘P轴方向陀螺仪的姿态角
  fp32 chassis_roll;  //陀螺仪和云台电机叠加的roll角度，底盘R轴方向陀螺仪的姿态角
