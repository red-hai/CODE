...
//					 }
         control.CMControl.forwardOrbackward = 0;
		      ...
		      case RC_SW_MID:
				  {
//					  control.CMControl.horizoltal        = (RemotData.rc.ch0 - 1027) * REMOT_HORIONTALSPEED;
//					  control.CMControl.forwardOrbackward = (RemotData.rc.ch1 - 1027) * REMOT_FORWARDSPEED;
//					  control.CMControl.DnfanceAngle = 0;

              control.CMControl.forwardOrbackward = 300;//400* REMOT_FORWARDSPEED;					  
...
//					   }
					  ...
					  if(RemotData.rc.s1 == RC_SW_UP)
						...
						//	control.CMControl.forwardOrbackward = 150* REMOT_FORWARDSPEED;

						}
						     xEventGroupClearBits(BolletFreControlEnt,0x03);
					 if(RemotData.rc.s1 == RC_SW_MID)
						  {
